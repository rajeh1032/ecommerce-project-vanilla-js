...
export var SearchUI = {
    ...
    searchAndDisplay: function(searchTerm, categoryId) {
        ...
        productsGrid.innerHTML = '<p class="loading-text" style="grid-column: 1/-1; text-align: center;">Searching...</p>';
        ...
        SearchService.searchProducts(searchTerm, categoryId, function(products) {
            if (products.length === 0) {
                productsGrid.innerHTML = '<p class="no-data" style="grid-column: 1/-1; text-align: center; padding: 50px; color: #999;">No products found matching your search.</p>';
            } else {
